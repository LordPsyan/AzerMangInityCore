...
std::vector<uint32> m_ignoreSpells =
{
	/*Mage spells*/
    11, 7268, 7269, 7270, 8418, 8419, 10273, 10274, 25346, 27076, 38700, 38703,
    ...
    50581, 30708, 48076, 62900, 62901, 62902, 59671, 50589, 66906, 66907, 24131, 23455, 23458, 23459, 27803, 27804, 27805, 25329, 48075, 42243, 42244, 42245, 42234, 58432, 58433, 65878, 18848, 16979, 49376, 54055, 20647, 42243, 24131, 35886,
    // COSMETIC SPELLS
...
public:
    ...
    void LearnSpellsForNewLevel(Player* player, uint32 newLevel)
    {
        ...
        for (uint32 i = 0; i < sSkillLineAbilityStore.GetNumRows(); ++i)
        {
            ...
            for (int j = 0; j < m_ignoreSpells.size(); ++j)
            {
                if (spellInfo->Id == m_ignoreSpells[j])
                    continue;
            }
